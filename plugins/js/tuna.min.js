(function () {
    ...
    Super = Object.create(null, {
      ...
      automate: {
        value: function (property, value, duration, startTime) {
          var start = startTime ? ~~(startTime / 1e3) : userContext.currentTime,
            dur = duration ? ~~(duration / 1e3) : 0,
  ...
  Tuna.prototype.Bitcrusher.prototype = Object.create(Super, {
    ...
    defaults: {
      writable: true,
      value: {
        bits: { value: 4, min: 1, max: 16, automatable: false, type: INT },
        bufferSize: {
          value: 4096,
          min: 256,
          max: 16384,
  ...
  Tuna.prototype.Compressor.prototype = Object.create(Super, {
    ...
    defaults: {
      ...
      value: {
        ...
        attack: { value: 1, min: 0, max: 1e3, automatable: true, type: FLOAT },
  ...
  Tuna.prototype.Filter.prototype = Object.create(Super, {
    ...
    defaults: {
      ...
      value: {
        ...
        bypass: { value: false, automatable: false, type: BOOLEAN },
        filterType: { value: "lowpass", automatable: false, type: STRING },
      },
    },
    filterType: {
      enumerable: true,
  ...
  Tuna.prototype.Gain.prototype = Object.create(Super, {
    ...
    defaults: {
      ...
      value: {
        bypass: { value: false, automatable: false, type: BOOLEAN },
        gain: { value: 1, automatable: true, type: FLOAT },
      },
    },
    gain: {
      enumerable: true,
  ...
  Tuna.prototype.Panner.prototype = Object.create(Super, {
    ...
    defaults: {
      ...
      value: {
        bypass: { value: false, automatable: false, type: BOOLEAN },
        pan: { value: 0, min: -1, max: 1, automatable: true, type: FLOAT },
      },
    },
    pan: {
      enumerable: true,
